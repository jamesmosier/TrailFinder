        ...
        trailfinder_map = new google.maps.Map(document.getElementById('map'), mapOptions);
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function (position) {
                    ...
                    + ' ORDER BY ST_DISTANCE(Coordinates, LATLNG(' + lat + ',' + lng + '))' + ' LIMIT ' + settings.queryLimit; 
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            for (var rowNumber in rows) {
                                ...
                                var directionsLink = "<div class='directions-link'><a class='btn btn-primary' href='http://maps.google.com/maps?saddr="
